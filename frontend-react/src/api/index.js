...
const api = axios.create({
  baseURL: 'https://backend-portofolio.nexama.my.id/public/api',
  headers: {
...
export const updateProject = (id, data) => api.post(`/projects/${id}`, data);
export const deleteProject = (id) => api.delete(`/projects/${id}`);

// Skills
export const getSkills = () => api.get('/skills');
export const createSkill = (data) => api.post('/skills', data);
export const updateSkill = (id, data) => api.post(`/skills/${id}`, data);
...
export const readMessage = (id) => api.patch(`/messages/${id}/read`);
...
export const updateCertificate = (id, data) => api.post(`/certificates/${id}`, data);
